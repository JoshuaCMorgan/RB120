...
Jacks are higher than 10s, Queens are higher than Jacks, 
Kings are higher than Queens, and Aces are higher than Kings. 
...
def find_max(cards)
  cards.max {|card| VALUES.fetch(card, card) }
end 
